...
func (f SMShutdownStartFunc) PreShutdown() error {
	return f()
}

func (f SMShutdownStartFunc) PostShutdown() error {
	return nil
}
...
func (f SMFinishFunc) PreShutdown() error {
	return nil
}

func (f SMFinishFunc) PostShutdown() error {
	return f()
}
...
func (f SMStartFunc) PreShutdown() error {
	return nil
}

func (f SMStartFunc) PostShutdown() error {
	return nil
}
...
func TestShutdownStartGetsCalled(t *testing.T) {
	...
	if len(c) != 1 {
		t.Error("Expected 1 PreShutdown, got ", len(c))
	}
}
...
func TestShutdownFinishGetsCalled(t *testing.T) {
	...
	if len(c) != 1 {
		t.Error("Expected 1 PostShutdown, got ", len(c))
	}
}
...
func TestErrorHandlerFromStartShutdown(t *testing.T) {
	...
	if len(c) != 1 {
		t.Error("Expected 1 error from PreShutdown, got ", len(c))
	}
}
...
func TestErrorHandlerFromFinishShutdown(t *testing.T) {
	...
	if len(c) != 1 {
		t.Error("Expected 1 error from PostShutdown, got ", len(c))
	}
}
